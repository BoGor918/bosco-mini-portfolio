...
export default function IntroductionModalComponent() {
  // style variable
  const headlineStyle = 'text-center font-medium text-[#334155] dark:text-white text-[20px] sm:text-[20px] md:text-[20px] lg:text-[25px]'
  const textStyle = 'mt-[0.5rem] text-justify text-[14px] sm:text-[14px] md:text-[14px] lg:text-[16px] text-[#334155] dark:text-[#94A3B8]'
  // translation
