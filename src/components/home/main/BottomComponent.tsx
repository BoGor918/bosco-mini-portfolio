...
export default function BottomComponent() {
    ...
    const navTextStyle = "text-slate-500 dark:text-slate-300 self-start ml-[5.5px] mt-[0.5rem] text-[12px] sm:text-[12px] md:text-[12px] lg:text-[14px] mb-[2px] lg:hidden animate-fade-up animate-delay-200 animate-once";
